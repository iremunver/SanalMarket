    ...
    public class Tree
    {
            ...
            public void Ekle(Urun deger)
            {
                ...
                while (tempSearch != null)
                {
                    ...
                    if ((int)deger.UrunNo == (int)tempSearch.Veri.UrunNo)
                        return;
                    else if ((int)deger.UrunNo < (int)tempSearch.Veri.UrunNo)
                ...
                if (kok == null)
                    kok = eklenecek;
                else if ((int)deger.UrunNo < (int)tempParent.Veri.UrunNo)
                                                ...
                                                int anahtar)
            {
                if (dugum == null)
                    return null;
                else if ((int)dugum.Veri.UrunNo == anahtar)
                    return dugum;
                else if ((int)dugum.Veri.UrunNo > anahtar)
            ...
            public bool Sil(int deger)
            {
                ...
                TreeNode parent = kok;
                bool isSol = true;
                while ((int)current.Veri.UrunNo != deger)
                {
                    parent = current;
                    if (deger < (int)current.Veri.UrunNo)
                    {
                        isSol = true;
                        current = current.Sol;
                    }
